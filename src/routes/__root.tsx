  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/" className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-secondary transition-colors">
            Go home
          </Link>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "UMP Consultants — Towards Growth" },
      { name: "description", content: "Research-driven consulting: market research, surveys, area coverage, promotions, marketing, events and strategic initiatives." },
      { name: "author", content: "UMP Consultants" },
