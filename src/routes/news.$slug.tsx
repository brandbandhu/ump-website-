...
export const Route = createFileRoute("/news/$slug")({
  loader: ({ params }) => {
    const post = NEWS.find((b) => b.slug === params.slug);
  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      links: [{ rel: "canonical", href: `/news/${p.slug}` }],
    };
  },
          ...
          <aside>
            <Reveal>
              <div className="card-soft p-6 sticky top-24">
                <p className="text-xs text-accent uppercase tracking-wider font-semibold">More news</p>
                ...
                <Link to="/news" className="mt-6 inline-flex items-center gap-2 text-primary font-semibold">
